...
let UsersController = class UsersController extends tsoa_1.Controller {
    getAllUser() {
        return __awaiter(this, void 0, void 0, function* () {
            return new usersService_1.UsersService().findAllUser();
        });
    }
    getUser(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            return new usersService_1.UsersService().findUser(userId);
        });
    }
    createUser(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            this.setStatus(201); // set return status 201
            return new usersService_1.UsersService().createUser(requestBody);
        });
    }
};
__decorate([
